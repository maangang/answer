    ...
    <div class="car_s_exam_context">
        ...
        <div class="exam_card">
            ...
            <div class="exam_card_body">
                <div>
                    <a href="<?php echo e(url('orders')); ?>" target="_blank" onclick="clickLog('from=JXEDT_HOME_LLKS_KM1_SSLX')"><span>顺序练习</span></a>
                    <a href="<?php echo e(url('getOrder')); ?>" target="_blank" onclick="clickLog('from=JXEDT_HOME_LLKS_KM1_SJLX')"><span>随机练习</span></a>
                </div>
                <div>
