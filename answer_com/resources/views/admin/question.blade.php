...
<script>
   /* $('#xiao').click(function () {
        ...
        $('.car_type').html('<IFRAME width=100% height=500 marginwidth=0 marginheight=0  src="xiaoche"></IFRAME>');
    });

    $('#huo').click(function () {
        // $('.hh').hide();
        $('.car_type').html('<IFRAME width=100% height=500 marginwidth=0 marginheight=0  src="huoche"></IFRAME>');
    });
    $('#ke').click(function () {
        // $('.hh').hide();
        $('.car_type').html('<IFRAME width=100% height=500 marginwidth=0 marginheight=0  src="keche"></IFRAME>');
    });

    $('#mo').click(function () {
        // $('.hh').hide();
        $('.car_type').html('<IFRAME width=100% height=500 marginwidth=0 marginheight=0  src="motuo"></IFRAME>');
    });
*/
